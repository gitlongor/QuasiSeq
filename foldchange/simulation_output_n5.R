...
for(i in 1:n.iter){
  ...
  repeat{
	...
	trulyDEgeneList = genes.samp[de.genes] ## save to a matrix and in a file
	...
	options(contrats=c('contr.sum','contr.sum'))
