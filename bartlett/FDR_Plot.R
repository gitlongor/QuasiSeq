...
fdp.spline <- readRDS(file.path(mainDir, subDir, paste0("ss", k.ind), "fdp_quasiseq_simseq.RDS"))
fdp.spline.bart <- readRDS(file.path(mainDir, subDir, paste0("ss", k.ind), "fdp_quasiseq_simseq_bart.RDS"))
...
fdp.spline <- readRDS(file.path(mainDir, subDir, paste0("ss", k.ind), "fdp_quasiseq_nb.RDS"))
fdp.spline.bart <- readRDS(file.path(mainDir, subDir, paste0("ss", k.ind), "fdp_quasiseq_nb_bart.RDS"))
