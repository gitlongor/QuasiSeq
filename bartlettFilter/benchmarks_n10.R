...
if( k.ind >= 7)
{
  ...
  pvals.quasiseq.cooks.simseq.bart <- readRDS(file.path(mainDir, subDir, paste0("ss", k.ind), "p_quasiseq_cooks_simseq_bart.RDS"))
  ...
  pvals.quasiseq.cooks.nb.bart <- readRDS(file.path(mainDir, subDir, paste0("ss", k.ind), "p_quasiseq_cooks_nb_bart.RDS"))
...
if(k.ind < 7)
{
  ...
  pau.quasiseq.cooks.simseq.bart <- pau.cooks(pvals.quasiseq.simseq.bart, filt.cooks.simseq, null.genes, specificity = 0.05)
  ...
  pau.quasiseq.cooks.nb.bart <- pau.cooks(pvals.quasiseq.nb.bart, filt.cooks.nb, null.genes, specificity = 0.05)
  ...
  pau.quasiseq.cooks.simseq.bart <- pau.cooks(pvals.quasiseq.cooks.simseq.bart, filt.cooks.simseq, null.genes, specificity = 0.05, pvals.list = TRUE)
  ...
  pau.quasiseq.cooks.nb.bart <- pau.cooks(pvals.quasiseq.cooks.nb.bart, filt.cooks.nb, null.genes, specificity = 0.05, pvals.list = TRUE)
...
if(k.ind < 7)
{
  ...
  fdp.quasiseq.cooks.simseq.bart <- fdp.cooks(pvals.quasiseq.simseq.bart, filt.cooks.simseq, null.genes, qval.cuts)
  ...
  fdp.quasiseq.cooks.nb.bart <- fdp.cooks(pvals.quasiseq.nb.bart, filt.cooks.nb, null.genes, qval.cuts)
  ...
  fdp.quasiseq.cooks.simseq.bart <- fdp.cooks(pvals.quasiseq.cooks.simseq.bart, filt.cooks.simseq, null.genes, qval.cuts, pvals.list = TRUE)
  ...
  fdp.quasiseq.cooks.nb.bart <- fdp.cooks(pvals.quasiseq.cooks.nb.bart, filt.cooks.nb, null.genes, qval.cuts, pvals.list = TRUE)
...
saveRDS(fdp.quasiseq.cooks.nb.bart, file.path(mainDir, subDir, paste0("ss", k.ind), "fdp_quasiseq_cooks_nb_bart.RDS"))
...
saveRDS(pau.quasiseq.cooks.nb.bart, file.path(mainDir, subDir, paste0("ss", k.ind), "pau_quasiseq_cooks_nb_bart.RDS"))
...
save.image('benchmarks_n10.RData')